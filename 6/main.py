...
def main():
	try:
		a,b,c,d,e,f, s, g, councils = import_data('6/test.txt')
	except:
		a,b,c,d,e,f, s, g, councils = import_data('test.txt')
	
	sol = GA(a,b,c,d,e,f,s,g,councils,100,100,0.1)
